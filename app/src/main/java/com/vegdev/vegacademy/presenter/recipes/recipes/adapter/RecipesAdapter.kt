package com.vegdev.vegacademy.presenter.recipes.recipes.adapter
...
class RecipesAdapter(
...
) : FirestorePagingAdapter<SingleRecipe, RecipesViewHolder>(options) {
    ...
    override fun onBindViewHolder(holder: RecipesViewHolder, position: Int, model: SingleRecipe) {
