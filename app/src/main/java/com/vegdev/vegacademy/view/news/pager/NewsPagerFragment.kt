...
class NewsPagerFragment(private val position: Int) : Fragment(), NewsPagerView {
    ...
    override fun hideLayout() {
        (parentFragment as NewsFragment).hideLayout()
    }

    override fun showLayout() {
        (parentFragment as NewsFragment).showLayout()
    }
}